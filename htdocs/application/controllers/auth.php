...
class Auth extends Controller {
	...
	function login($state)
	{
		...
		else
		{
                	...
                	if ($this->redux_auth->login($username, $password))
			{
	...
	function register()
	{
		...
		// validates, calls redux_auth->register
		...
		$this->form_validation->set_rules('recaptcha_response_field','ReCAPTCHA','required|callback_check_captcha');
			...
			// register user
                	...
                	list($register, $reason) = $this->redux_auth->register($username, $password, $email);
	...
	function lostpass()
	{
		...
		$this->form_validation->set_rules('email', 'Email Address', 'required');
            	...
            	{
                	$email = $this->input->post('email');
                        list($result,$reason) = $this->redux_auth->forgotten_password($email);
	...
	function resetpass()
	{
                ...
                else
		{
			...
			list($result,$reason) = $this->redux_auth->forgotten_password_complete($code,$newpass);
