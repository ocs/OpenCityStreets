...
<P>
Either <A HREF="<?= $this->config->site_url(); ?>auth/activatebyclick/<?= $activation ?>">Click 
here</A>, or return to the game web site, choose Activate Account when asked to log in, and enter your username and this code:
<P>
<b><?= $activation; ?></b>
<P>
